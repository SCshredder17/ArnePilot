...
confs = [
  ...
  {'name': 'dp_dynamic_follow_multiplier', 'default': 0.75, 'type': 'Float32', 'min': 0.75, 'max': 9.99, 'depends': [{'name': 'dp_atl', 'vals': [False]}], 'conf_type': ['param']},
  {'name': 'dp_dynamic_follow_min_tr', 'default': 0.75, 'type': 'Float32', 'min': 0.75, 'max': 9.99, 'depends': [{'name': 'dp_atl', 'vals': [False]}], 'conf_type': ['param']},
