...
class opParams:
  def __init__(self):
    ...
    self.fork_params = {'awareness_factor': Param(100., VT.number, 'Multiplier for the awareness times'),
                        ...
                        'offset_limit': Param(0.0, VT.number, 'Speed at which apk percent offset will work in m/s'),
                        ...
                        'indi_inner_gain_v': Param([5, 12, 15], [list, float, int], live=True, depends_on='enable_indi_live'),
                        'indi_outer_gain_bp': Param([18, 22, 26], [list, float, int], live=True, depends_on='enable_indi_live'),
                        'indi_outer_gain_v': Param([4, 11, 14.99], [list, float, int], live=True, depends_on='enable_indi_live'),
                        ...
                        'indi_actuator_effectiveness_v': Param([5, 12, 15], [list, float, int], live=True, depends_on='enable_indi_live'),
