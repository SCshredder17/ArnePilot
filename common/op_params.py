...
class opParams:
  def __init__(self):
    ...
    self.fork_params = {CAM_OFFSET: Param(0.06, VT.number, 'Your camera offset to use in lane_planner.py', live=True),
                        'indi_inner_gain': Param(15.0, VT.number, live=True, depends_on=SHOW_INDI_PARAMS),
                        'indi_outer_gain': Param(14.9, VT.number, live=True, depends_on=SHOW_INDI_PARAMS),
                        'indi_time_constant': Param(5.5, VT.number, live=True, depends_on=SHOW_INDI_PARAMS),
                        'indi_actuator_effectiveness': Param(15.0, VT.number, live=True, depends_on=SHOW_INDI_PARAMS),
                        SHOW_ACTUATOR_DELAY_PARAMS: Param(True, bool, live=True, depends_on=ENABLE_LAT_PARAMS),
                        STEER_ACTUATOR_DELAY: Param(0.45, VT.number, live=True, depends_on=SHOW_ACTUATOR_DELAY_PARAMS),
                        ENABLE_ACTUATOR_DELAY_BPS: Param(False, bool, live=True, depends_on=SHOW_ACTUATOR_DELAY_PARAMS),
                        STEER_ACTUATOR_DELAY_BP: Param([7, 9], [list, float, int], live=True, depends_on=ENABLE_ACTUATOR_DELAY_BPS),
                        STEER_ACTUATOR_DELAY_V: Param([0.12, 0.45], [list, float, int], live=True, depends_on=ENABLE_ACTUATOR_DELAY_BPS),
                        ...
                        'alca_min_speed': Param(0.0, VT.number, 'The minimum speed allowed for an automatic lane change (in MPH)'),
                        ...
                        ENABLE_INDI_BREAKPOINTS: Param(True, bool, live=True, depends_on=SHOW_INDI_PARAMS),
                        INDI_INNER_GAIN_BP: Param([18, 22, 26], [list, float, int], live=True, depends_on=ENABLE_INDI_BREAKPOINTS),
                        INDI_INNER_GAIN_V: Param([9, 12, 15], [list, float, int], live=True, depends_on=ENABLE_INDI_BREAKPOINTS),
                        INDI_OUTER_GAIN_BP: Param([18, 22, 26], [list, float, int], live=True, depends_on=ENABLE_INDI_BREAKPOINTS),
                        INDI_OUTER_GAIN_V: Param([8, 12, 14.9], [list, float, int], live=True, depends_on=ENABLE_INDI_BREAKPOINTS),
                        INDI_TIME_CONSTANT_BP: Param([18, 22, 26], [list, float, int], live=True, depends_on=ENABLE_INDI_BREAKPOINTS),
                        INDI_TIME_CONSTANT_V: Param([1, 3, 4.5], [list, float, int], live=True, depends_on=ENABLE_INDI_BREAKPOINTS),
                        INDI_ACTUATOR_EFFECTIVENESS_BP: Param([18, 22, 26], [list, float, int], live=True, depends_on=ENABLE_INDI_BREAKPOINTS),
                        INDI_ACTUATOR_EFFECTIVENESS_V: Param([9, 12, 15], [list, float, int], live=True, depends_on=ENABLE_INDI_BREAKPOINTS),
                        ENABLE_MULTI_INDI_BREAKPOINTS: Param(True, bool, live=True, depends_on=SHOW_INDI_PARAMS),
